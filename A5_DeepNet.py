...
class Net(nn.Module):
    def __init__(self):
        ...
        ##############################
        # for non-square kernel you would specify as (3,5) for example
        self.conv1 = nn.Conv2d(1,20,5,stride=1,padding=0,dilation=1)
        #nn.Conv2d(chansIn,chansOut,kernelSize,stride,padding,dilation,groups,bias,paddingMode)
        self.conv2 = nn.Conv2d(20,50,5,stride=1,padding=0,dilation=1)
